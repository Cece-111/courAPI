...
export const initHandlers = (app: Application) => {
    ...
    app.post("/products", async (req: Request, res: Response) => {
        try {
            ...
            console.log("DEBUG: validation.value", validation.value)
    ...
    app.put("/products/:id", async (req: Request, res: Response) => {
        try {
            ...
            const updateProductRequest = CreateProductValidation.validate(req.body).value
            const updatedProduct = await productRepository.save({ ...product, ...updateProductRequest })
